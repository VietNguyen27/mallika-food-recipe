...
export const PhoneRectContext = createContext({});
...
const Phone = ({ children }: PhoneProps) => {
  ...
  return (
    <PhoneRectContext.Provider value={{ rect }}>
      <Wrapper>
        <>
          <div className='w-phone h-phone rounded-phone relative bg-black shadow-phone flex justify-center items-stretch'>
            <div className='absolute w-full h-full pointer-events-none select-none'>
              ...
              <div className='relative z-50 w-full flex justify-between px-layout pt-1.5'>
            ...
            <main
              className='relative bg-white w-full h-full rounded-phone pt-9 pb-6 overflow-hidden'
              ref={ref}
            >
              {children}
            </main>
